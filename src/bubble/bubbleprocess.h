...
public:
    ...
    static vector<bubblePoint> convertGrayImage2Bub(cv::Mat grayImage, int focalLengthPixels, int maxval, float angleOffset);

    static vector<bubblePoint> convertOmniGrayImage2Bub(cv::Mat grayImage, int maxval);

    static vector<bubblePoint> convertOmniGrayImage2BubFront(cv::Mat grayImage, int maxval);

    static vector<bubblePoint> convertOmniGrayImage2BubFrontBar(cv::Mat grayImage, int maxval);

    static vector<bubblePoint> convertOmniGrayImage2BubCustom(cv::Mat grayImage, int maxval, int lower_cut_size, int upper_cut_size);

    static vector<bubblePoint> convertOmniGrayImage2BubFrontCustom(cv::Mat grayImage, int maxval, int lower_cut_size, int upper_cut_size);

    static vector<bubblePoint> convertOmniGrayImage2BubFrontBarCustom(cv::Mat grayImage, int maxval, int lower_cut_size, int upper_cut_size);
